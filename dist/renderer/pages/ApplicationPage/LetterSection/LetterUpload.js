...
var LetterUpload = function (_a) {
    ...
    return (<microComponents_1.FilePicker label='Upload letter PDF' accept='.pdf' onChange={function (event) { return saveCVPdfHandler(event.target.files[0].path); }} id='uploadCVPdfPicker'/>);
};
exports["default"] = LetterUpload;
//# sourceMappingURL=LetterUpload.js.map